import { subtractHours, todayDate } from "@core/lib/date";
...
const commentsPage1: IPagination<IComment[]> = {
  ...
  data: [
    {
      id: 1,
      created: subtractHours(todayDate, 1).toISOString(),
    ...
    {
      id: 13,
      created: subtractHours(todayDate, 3).toISOString(),
    ...
    {
      id: 2,
      created: subtractHours(todayDate, 6).toISOString(),
    ...
    {
      id: 3,
      created: subtractHours(todayDate, 7).toISOString(),
    ...
    {
      id: 4,
      created: subtractHours(todayDate, 8).toISOString(),
...
const commentsPage2: IPagination<IComment[]> = {
  pagination: {
    page: 2,
    size: 6,
    total_pages: 3,
...
const commentsPage3: IPagination<IComment[]> = {
  pagination: {
    page: 3,
    size: 6,
    total_pages: 3,
